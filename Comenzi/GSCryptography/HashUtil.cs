...
namespace GSCryptography
{
    public class HashUtil
    {
        ...
        public static byte[] EncodeHash(string strPlain, HashType hshType)
        {
            byte[] byteRet;
            switch (hshType)
            {
                case HashType.MD5: byteRet = EncodeMD5(strPlain); break;
                default: byteRet = null; break;
            }
            return byteRet;
        }
        ...
        private static byte[] EncodeMD5(string strPlain)
        {
            UnicodeEncoding UE = new UnicodeEncoding();
