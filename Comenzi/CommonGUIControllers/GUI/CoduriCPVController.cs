...
{
    public class CoduriCPVController: Controller
    {
         #region Constructor

        public CoduriCPVController()
        {
        }
        ...
        public override bool LoadServer()
        {
            try
            {
                CoduriCPVDataSvc mDataSvc = new CoduriCPVDataSvc();
                mDataSvc.GetCodCPV(mDataSet);
        ...
        public override bool PerformServer()
        {
            try
            {
                CoduriCPVDataSvc svc = new CoduriCPVDataSvc();
